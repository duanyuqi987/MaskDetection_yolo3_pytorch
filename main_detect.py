...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/maskdet_yolov3.cfg', help='cfg file path')
    parser.add_argument('--classes', type=str, default='cfg/maskdet_classes.txt', help='classes.txt file path')
    parser.add_argument('--weights', type=str, default='cfg/maskdet_train.pt', help='path to weights file')
