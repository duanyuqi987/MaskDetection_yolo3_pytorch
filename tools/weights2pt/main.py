...
def convert(cfg='cfg/maskdet_yolov3.cfg', weights='cfg/maskdet_train.weights'):
    ...
    if weights.endswith('.pt'):  # if PyTorch format
        ...
        model.load_state_dict(torch.load(weights, map_location='cpu')['model'])  #原来的
...
if __name__ == '__main__':
    cfg = "../口罩识别/maskDetection_yolo3_pytorch/cfg/coco_yolov3.cfg"
    #weights = "../口罩识别/maskDetection_yolo3_pytorch/cfg/coco_train.weights"
    weights = "../口罩识别/maskDetection_yolo3_pytorch/cfg/coco_train.pt"
    convert(cfg,weights)
